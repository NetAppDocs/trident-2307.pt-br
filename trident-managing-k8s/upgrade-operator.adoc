...
* Para clusters que executam o Kubernetes 1,24 ou anterior, link:https://github.com/NetApp/trident/tree/stable/v23.07/deploy/bundle_pre_1_25.yaml["bundle_pre_1_25.yaml"^]use o .
* Para clusters que executam o Kubernetes 1,25 ou posterior, link:https://github.com/NetApp/trident/tree/stable/v23.07/deploy/bundle_post_1_25.yaml["bundle_post_1_25.yaml"^]use o .
...
----
. Exclua o operador Trident que foi usado para instalar a instância atual do Astra Trident. Por exemplo, se você estiver atualizando do 23,04, execute o seguinte comando:
+
[listing]
----
...
. Use o `helm upgrade` comando onde `trident-operator-23.07.1.tgz` reflete a versão para a qual você deseja atualizar.
+
[listing]
----
